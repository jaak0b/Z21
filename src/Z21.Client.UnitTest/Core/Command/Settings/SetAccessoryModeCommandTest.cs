...
namespace Z21.UnitTest.Core.Command.Settings
{
  public class SetAccessoryModeCommandTest
  {
    ...
    {
      ArgumentException? exception = Assert.Throws<ArgumentException>(() => _ = new SetAccessoryModeCommand(12, DecoderMode.Unknown));
