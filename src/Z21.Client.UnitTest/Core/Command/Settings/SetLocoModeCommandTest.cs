...
namespace Z21.UnitTest.Core.Command.Settings
{
  public class SetLocoModeCommandTest
  {
    ...
    {
      SetLocoModeCommand command = new(12, decoderMode);
    ...
    {
      ArgumentException? exception = Assert.Throws<ArgumentException>(() => _ = new SetLocoModeCommand(12, DecoderMode.Unknown));
