...
{
  public class LocoSpeedHelperTest
  {
    ...
    {
      Assert.That(LocoSpeedHelper.CalculateDccSpeed(DccSpeedMode.Steps14, speedStep), Is.EqualTo(dccSpeed));
    }
    ...
    {
      Assert.That(LocoSpeedHelper.CalculateDccSpeed(DccSpeedMode.Steps128, speedStep), Is.EqualTo(dccSpeed));
    }
    ...
    {
      Assert.That(LocoSpeedHelper.CalculateDccSpeed(DccSpeedMode.Steps28, speedStep), Is.EqualTo(dccSpeed));
    }
    ...
    {
      Assert.That(LocoSpeedHelper.CalculateSpeedStep(DccSpeedMode.Steps14, dccSpeed), Is.EqualTo(speedStep));
    }
    ...
    {
      Assert.That(LocoSpeedHelper.CalculateSpeedStep(DccSpeedMode.Steps128, dccSpeed), Is.EqualTo(speedStep));
    }
    ...
    {
      Assert.That(LocoSpeedHelper.CalculateSpeedStep(DccSpeedMode.Steps28, (ushort)dccSpeed), Is.EqualTo((ushort)speedStep), $"Dcc Speed: {dccSpeed}. Expected speed step: {speedStep}");
    }
  }
}